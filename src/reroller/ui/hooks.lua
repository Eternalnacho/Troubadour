...
create_UIBox_your_collection = function()
  ...
  table.insert(ret.nodes[1].nodes[1].nodes[1].nodes, (Troubadour.collection_from_button or next(Troubadour.collection_targets)) and Troubadour.UIDEF.auto_reroll_menu_UI())
  return ret
end
