          ...
          T.Col ({ r = 0.2, padding = 0.1, colour = T.C.colour }, {
            ...
            T.Row (
              {
                ...
                TRO_dark_tooltip = 'TRO_ctrls_extra' ..
                  (Troubadour.config.invert_tile_controls and '_i' or '') },
              {
                create_toggle({
                  align = 'cr',
                  active_colour = T.C.buttons,
            ...
            T.Row ({}, {
              T.Col ({ r = 0.1, colour = G.C.GREY, emboss = 0.05 }, {
                create_slider({
                  label = 'Mod List Height',
                  label_scale = 0.45,
                  w = 4, h = 0.3,
                  colour = Troubadour.config.mod_icons_only
                    and T.C.active
                    or darken(copy_table(G.C.GREY), 0.5),
                  ref_table = Troubadour.config, ref_value = 'mod_page_height',
                  min = 4, max = 6
                }),
                create_slider({
                  label = 'Mod List Width',
                  label_scale = 0.45,
                  w = 4, h = 0.3,
                  colour = Troubadour.config.mod_icons_only
                    and T.C.active
